...
description: Keep normal single-agent growth continuous without enabling full multi-agent scheduling.
---

# MALTS Skill Bridge

MALTS_SKILL_BRIDGE: single-agent-lightweight-growth
...
3. Verify `<MALTS_ROOT>/skills/single-agent-lightweight-growth/SKILL.md` exists.
