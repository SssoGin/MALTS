...
公开仓库默认以英文源文档为事实源。简体中文公开入口位于 [README.zh-CN.md](README.zh-CN.md)，公开中文文档位于 `docs/zh-CN/`。Agent 执行事实源仍是英文文档和根级 `skills/`。双语维护规则见 [docs/zh-CN/BILINGUAL_DOCS.md](docs/zh-CN/BILINGUAL_DOCS.md)。
